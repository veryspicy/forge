const local: App.I18n.Schema = {
  ...
  page: {
    ...
    ordersDetail: {
      ...
      rejectOrder: '拒绝订单',
      rejectReason: '拒绝原因',
      reasonPaymentNotVerified: '付款未核实',
      reasonOutOfStock: '缺货 / 已下架',
      reasonSuspectedFraud: '疑似欺诈订单',
      reasonInvalidAddress: '收货地址无效或不完整',
      reasonCustomerCancelled: '客户要求取消',
      reasonCustomerRefund: '客户申请退款',
      reasonReturnReceived: '已收到退货',
      reasonDamagedItem: '商品损坏或存在缺陷',
      reasonDuplicatePayment: '重复付款',
      reasonShippingDelay: '物流延误 / 包裹丢失',
      reasonGoodwill: '善意补偿 / 价格调整',
      reasonCannotFulfill: '缺货 / 无法履约',
      reasonPaymentTimeout: '未在规定时间内完成付款',
      reasonOther: '其他',
      productId: '商品 ID',
      subtotal: '小计',
      addressLine1: '地址行1',
      ...
      statusPending: '待处理',
      statusConfirmed: '已付款 · 待审核',
      statusProcessing: '处理中',
      statusProcuring: '采购中',
      statusProcureFailed: '采购失败',
      statusShipped: '已发货',
      statusDelivered: '已确认收货',
      statusCancelled: '已取消',
      statusRefunded: '已退款',
      paymentUnpaid: '未支付',
      paymentPaid: '已支付',
