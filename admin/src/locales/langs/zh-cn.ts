const local: App.I18n.Schema = {
  ...
  request: {
    ...
    timeoutReloading: '连接超时，正在刷新页面，请稍候重试'
  },
  theme: {
  ...
  page: {
    ...
    products: {
      ...
      confirmBatch: '确认对选中的 {n} 个商品执行该操作？',
      deleteConfirm: '确定删除该商品？删除后可在「已删除」状态下查看。',
      deleteSuccess: '删除成功',
      statusUpdated: '状态已更新',
      total: '共 {n} 条',
      perPage: '每页'
