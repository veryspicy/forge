const local: App.I18n.Schema = {
  ...
  page: {
    ...
    returns: {
      ...
      reviewNote: '审核备注',
      noReturns: '暂无售后申请',
      rejectNoteRequired: '驳回售后申请必须填写原因',
      reasonDamaged: '商品损坏或有质量问题',
      reasonWrongItem: '收到错误商品',
      ...
      shippingCheck: '退运费',
      submit: '提交',
      receiveConfirm: '：确认已收到回寄商品？',
      closeConfirm: '：关闭后该售后申请将终止，确定关闭？',
      reviewFailed: '审核失败',
      refundFailed: '退款失败',
    ...
    shipments: {
      ...
      eta: '预计到达',
      statusAll: '全部状态',
      searchPlaceholder: '运单号 / 承运商 / 订单号',
      totalCount: '共 {total} 条运单',
    ...
    orders: {
      ...
      fulfillmentDropship: '一件代发',
      fulfillmentMixed: '混合',
      fulfillmentSelfPurchase: '自采购',
      paymentRefund: '支付/退款',
      refundedSuffix: ' / 已退 {amount}',
      purchaseList: '待采购清单',
      purchaseListTitle: '待采购清单（代发行）',
      purchaseEmpty: '当前没有待采购的代发行',
      purchaseLoadFailed: '待采购清单加载失败',
      purchaseExportFailed: '待采购清单导出失败',
      exportPurchase: '导出 CSV',
      supplierName: '供应商',
      supplierSku: '供应商 SKU',
      unspecifiedSupplier: '未指定供应商',
      supplierSummary: '{name}（{count} 项 / {qty} 件）',
      procurementStatus: '采购状态',
      procurementPending: '未采购',
      procurementRequested: '采购中',
      procurementReceived: '已入库',
      procurementAll: '全部',
      procurementRequestedAt: '推送时间',
      destination: '收货地'
    },
    archive: {
      viewActive: '进行中',
      ...
      action: '归档',
      actionBatch: '批量归档',
      confirm: '确认归档该{target}？归档后不再出现在列表与看板，可在「已归档」视图中恢复。',
      confirmBatch: '确认归档所选 {n} 个{target}？归档后不再出现在列表与看板，可在「已归档」视图中恢复。',
      done: '已归档 {n} 个{target}',
      skipped: '{n} 个{target}此前已归档',
      missing: '{n} 个{target}不存在，已跳过',
      empty: '没有可归档的{target}',
      failed: '归档失败',
      restore: '恢复',
      restoreBatch: '批量恢复',
      restoreConfirm: '确认恢复该{target}？恢复后将重新出现在列表与看板。',
      restoreConfirmBatch: '确认恢复所选 {n} 个{target}？恢复后将重新出现在列表与看板。',
      restoreDone: '已恢复 {n} 个{target}',
      restoreSkipped: '{n} 个{target}此前未归档',
      restoreMissing: '{n} 个{target}不存在，已跳过',
      restoreEmpty: '没有可恢复的{target}',
      restoreFailed: '恢复失败',
      targetOrder: '订单',
      targetReturn: '售后单',
      targetShipment: '运单'
    ...
    ordersDetail: {
      ...
      shipFailed: '发货失败',
      refundFailed: '退款失败',
      rejectReasonRequired: '拒绝订单必须填写原因',
      reasonPlaceholder: '选择或输入原因',
      productId: '商品 ID',
      subtotal: '小计',
      addressLine1: '地址行1',
      city: '城市',
      ...
      paymentMethod: '支付方式',
      paymentStatus: '支付状态',
      paymentIntentId: '交易 ID',
      paidAt: '支付时间',
      notPaid: '未支付',
      timeline: '订单时间轴',
      event_pending: '订单创建',
      event_paid: '支付成功',
      event_confirmed: '订单确认',
      event_shipped: '订单发货',
      event_delivered: '订单送达',
      event_cancelled: '订单取消',
      event_refunded: '订单退款',
      shipments: '运单记录',
      noShipments: '暂无运单',
      trackingUrl: '物流链接',
    ...
    users: {
      ...
      resetPassword: '重置密码',
      delete: '删除',
      deleteConfirm: '确认删除客户“{email}”？删除后不可恢复。',
      deleteSuccess: '客户已删除',
      freezeConfirm: '确认禁用客户“{email}”？禁用后该客户将无法登录。',
      unfreezeConfirm: '确认启用客户“{email}”？启用后该客户将可以正常登录。',
      freezeSuccess: '已禁用',
      unfreezeSuccess: '已启用',
      resetSuccess: '密码已重置',
      saved: '保存成功',
    ...
    aiConfig: {
      ...
      apiKeyHint: '留空保存则保留已存储密钥，不会明文回显',
      apiKeyConfigured: '密钥已配置',
      apiKeyNotConfigured: '密钥未配置',
      enabled: '启用 AI 能力',
      modelSection: '模型选择',
      model: '模型',
  ...
  errors: {
    ...
    CUSTOMER_CANNOT_DELETE: '该客户已有订单或宠物档案，禁止删除，可改为冻结',
