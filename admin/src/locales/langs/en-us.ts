const local: App.I18n.Schema = {
  ...
  page: {
    ...
    products: {
      ...
      batchDelete: 'Batch Delete',
      selectProduct: 'Please select products first',
      confirmBatch: 'Apply this action to {n} selected product(s)?',
      deleteConfirm: 'Delete this product? It will be visible under "Deleted" status.',
