const local: App.I18n.Schema = {
  ...
  page: {
    ...
    ordersDetail: {
      ...
      reasonPaymentNotVerified: 'Payment not verified',
      reasonOutOfStock: 'Out of stock / discontinued',
      reasonSuspectedFraud: 'Suspected fraudulent order',
      reasonInvalidAddress: 'Invalid or incomplete shipping address',
      reasonCustomerCancelled: 'Customer requested cancellation',
      reasonCustomerRefund: 'Customer requested refund',
      reasonReturnReceived: 'Returned items received',
      reasonDamagedItem: 'Damaged or defective item',
      reasonDuplicatePayment: 'Duplicate payment',
      reasonShippingDelay: 'Shipping delay / lost parcel',
      reasonGoodwill: 'Goodwill / price adjustment',
      reasonCannotFulfill: 'Out of stock / cannot fulfill',
      reasonPaymentTimeout: 'Payment not completed in time',
      reasonOther: 'Other',
      ...
      statusConfirmed: 'Paid · Awaiting Review',
