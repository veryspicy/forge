...
const DEFAULT_SITE_CONFIG = {
  ...
  i18n: {
    ...
    translations: {
      en: {
        ...
        'cat.food': 'Pet Food',
        'cat.toys': 'Toys',
        'cat.healthWellness': 'Health & Wellness',
        'cat.accessories': 'Accessories',
        'footer.shop': 'Shop',
        'footer.support': 'Support',
        'footer.about': 'About',
        'footer.legal': 'Legal',
        'footer.petFood': 'Pet Food',
        'footer.toys': 'Toys',
      ...
      zh: {
        ...
        'hero.title': '给宠物最好的陪伴',
        'hero.subtitle': 'AI 驱动的智能购物，为您的毛孩子挑选最好的。',
        'hero.cta1Label': '立即选购',
        'hero.cta2Label': '添加您的宠物'
      },
      de: {
        'nav.home': 'Startseite',
        'nav.products': 'Produkte',
        'nav.pets': 'Meine Haustiere',
        'nav.orders': 'Bestellungen',
        'nav.chat': 'KI-Chat',
        'cat.food': 'Tierfutter',
        'cat.toys': 'Spielzeug',
        'cat.healthWellness': 'Gesundheit & Wohlbefinden',
        'cat.accessories': 'Zubehör',
        'footer.shop': 'Shop',
        'footer.support': 'Hilfe',
        'footer.about': 'Über uns',
        'footer.legal': 'Rechtliches',
        'footer.petFood': 'Tierfutter',
        'footer.toys': 'Spielzeug',
        'footer.healthWellness': 'Gesundheit & Wohlbefinden',
        'footer.faqs': 'FAQ',
        'footer.shippingInfo': 'Versandinformationen',
        ...
        'hero.subtitle': 'Intelligentes Einkaufen für Ihre pelzigen Freunde, unterstützt von KI.',
        'hero.cta1Label': 'Jetzt einkaufen',
        'hero.cta2Label': 'Haustier hinzufügen'
      },
      fr: {
        'nav.home': 'Accueil',
        ...
        'nav.chat': 'Chat IA',
        'cat.food': 'Aliments pour animaux',
        'cat.toys': 'Jouets',
        'cat.healthWellness': 'Santé et bien-être',
        'cat.accessories': 'Accessoires',
        'footer.shop': 'Boutique',
        'footer.support': 'Aide',
        'footer.about': 'À propos',
        'footer.legal': 'Légal',
        'footer.petFood': 'Aliments pour animaux',
        'footer.toys': 'Jouets',
        'footer.healthWellness': 'Santé et bien-être',
        'footer.faqs': 'FAQ',
        ...
        'hero.title': 'Votre animal mérite le meilleur',
        'hero.subtitle': "Shopping intelligent pour vos amis à fourrure, propulsé par l'IA.",
        'hero.cta1Label': 'Acheter maintenant',
        'hero.cta2Label': 'Ajouter votre animal'
      },
      ar: {
        'nav.home': 'الرئيسية',
        'nav.products': 'المنتجات',
        'nav.pets': 'حيواناتي الأليفة',
        'nav.orders': 'الطلبات',
        'nav.chat': 'الدردشة الذكية',
        'cat.food': 'طعام الحيوانات الأليفة',
        'cat.toys': 'الألعاب',
        'cat.healthWellness': 'الصحة والعافية',
        'cat.accessories': 'الإكسسوارات',
        'footer.shop': 'المتجر',
        'footer.support': 'الدعم',
        'footer.about': 'من نحن',
        'footer.legal': 'القانون',
        'footer.petFood': 'طعام الحيوانات الأليفة',
        'footer.toys': 'الألعاب',
        'footer.healthWellness': 'الصحة والعافية',
        ...
        'hero.title': 'حيوانك الأليف يستحق الأفضل',
        'hero.subtitle': 'تسوق ذكي لأصدقائك ذوي الفراء، مدعوم بالذكاء الاصطناعي.',
        'hero.cta1Label': 'تسوق الآن',
        'hero.cta2Label': 'أضف حيوانك الأليف'
      }
  ...
  homeHero: {
    ...
    hero: {
      ...
      subtitle: 'AI-powered product recommendations tailored to your pet.',
...
export const THEME_PRESETS: Record<
  string,
  { label: string; swatch: string[]; colors: Partial<typeof DEFAULT_SITE_CONFIG.theme> }
> = {
  forge: {
    label: 'Forge 绿 (默认)',
...
export const useDiyStore = defineStore('diy-store', () => {
  ...
  async function saveSiteConfig() {
    ...
    if (Array.isArray(siteConfig.categories)) {
      siteConfig.categories.forEach((c: any, i: number) => {
        ...
        if (c.nameKey) {
          ...
          if (k.startsWith('cat.')) {
            c.nameKey = k;
          } else if (k.startsWith('footer.')) {
            c.nameKey = `cat.${k.replace(/^footer\./, '')}`;
          } else {
            c.nameKey = `cat.${k}`;
          }
        }
    ...
    if (siteConfig.footer?.linkGroups) {
      siteConfig.footer.linkGroups.forEach((g: any, i: number) => {
        g.order = i;
      });
    }
